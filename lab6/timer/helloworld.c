...
void interrupt_handler_dispatcher(void* ptr) {
	...
	if (intc_status & XPAR_BLINK_0_INTERRUPT_MASK){
		...
		xil_printf("Hellohello I wanna see the sun\r\n");
...
int main (void) {
    ...
    BLINK_mWriteSlaveReg0(XPAR_BLINK_0_BASEADDR, 0, 0x3);
    BLINK_mWriteSlaveReg1(XPAR_BLINK_0_BASEADDR, 0, 0xffffff);

    int temp1, temp2;
    temp1 = BLINK_mReadReg(XPAR_BLINK_0_BASEADDR, BLINK_SLV_REG0_OFFSET);
    xil_printf("%x\n\r",temp1);
    temp2 = BLINK_mReadReg(XPAR_BLINK_0_BASEADDR, BLINK_SLV_REG1_OFFSET);
    xil_printf("%x\n\r",temp2);
    ...
    XIntc_EnableIntr(XPAR_INTC_0_BASEADDR,
    		(XPAR_PUSH_BUTTONS_5BITS_IP2INTC_IRPT_MASK | XPAR_BLINK_0_INTERRUPT_MASK));
