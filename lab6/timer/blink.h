/*****************************************************************************
* Filename:          C:\Users\superman\Desktop\korea\SpaceInvaderTestHW2/drivers/blink_v1_00_a/src/blink.h
* Version:           1.00.a
* Description:       blink Driver Header File
* Date:              Tue Nov 04 17:15:42 2014 (by Create and Import Peripheral Wizard)
*****************************************************************************/
...
#define BLINK_SLV_REG1_OFFSET (BLINK_USER_SLV_SPACE_OFFSET + 0x00000004)
...
#define BLINK_mWriteSlaveReg1(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (BLINK_SLV_REG1_OFFSET) + (RegOffset), (Xuint32)(Value))

#define BLINK_mReadSlaveReg0(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (BLINK_SLV_REG0_OFFSET) + (RegOffset))
#define BLINK_mReadSlaveReg1(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (BLINK_SLV_REG1_OFFSET) + (RegOffset))
